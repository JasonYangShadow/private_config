...
BASE_ADD=(unclutter redshift vlc cmake viewnior markdown mupdf zathura zathura-cb zathura-djvu zathura-ps zathura-pdf-mupdf fcitx fcitx-gtk3 fcitx-configtool fcitx-googlepinyin fcitx-kkc xfce4-power-manager isousb cronie shadowsocks proxychains-ng tor arm dnsutils xclip compton)
SOFTWARES=(firefox thunderbird slack-desktop xfce4-terminal-base16-colors-git uget filezilla xmind visual-paradigm-community wps-office ttf-wps-fonts ttf-ms-fonts boost gtest ctags telegram-desktop-bin latex-beamer nodejs npm nodejs-hexo-cli neofetch texlive-most inkscape clang wqy-microhei docker teamviewer qt4 bleachbit python2-pip python-pip arc-gtk-theme numix-square-icon-theme)
